...
class Main extends Sprite
{
	...
	function onCrash(e:UncaughtErrorEvent):Void
	{
		...
		var randoms:Array<String> = ['Error!', 'Buh?', 'Uh Oh!', 'Wipe Out!', 'Dangit!', 'BLORT!', 'I Messed Up!', 'Oops!', 'Ouch!', 'Sorry!', 'God damnit!', 'Try Again!', 'Crash!', 'Ow!', 'That Stinks!', 'Help!', 'Oh Come On!', 'Really?!', 'Ugh!', 'That Was Stupid!', 'Bruh.'];
