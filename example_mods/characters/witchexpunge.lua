...
function onCreatePost()
    ...
    if getProperty('dad.curCharacter') == 'witchexpunge' then
        strums = 'opponent'
        characterBool = false
    elseif getProperty('boyfriend.curCharacter') == 'witchexpunge' then
        strums = 'player'
        characterBool = true
    end
    if getProperty('boyfriend.curCharacter') == 'witchexpunge' and getProperty('dad.curCharacter') == 'witchexpunge' then
        both = true
    end
