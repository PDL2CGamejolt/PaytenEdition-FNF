...
function onCreatePost()
    ...
    if getProperty('dad.curCharacter') == 'expungedistrue' then
        strums = 'opponent'
        characterBool = false
    elseif getProperty('boyfriend.curCharacter') == 'expungedistrue' then
        strums = 'player'
        characterBool = true
    end
    if getProperty('boyfriend.curCharacter') == 'expungedistrue' and getProperty('dad.curCharacter') == 'expungedistrue' then
        both = true
    end
