...
function onCreatePost()
    ...
    if getProperty('dad.curCharacter') == 'ambreaker' then
        strums = 'opponent'
        characterBool = false
    elseif getProperty('boyfriend.curCharacter') == 'ambreaker' then
        strums = 'player'
        characterBool = true
    end
    if getProperty('boyfriend.curCharacter') == 'ambreaker' and getProperty('dad.curCharacter') == 'ambreaker' then
        both = true
    end
