...
function onCreatePost()
    ...
    if getProperty('dad.curCharacter') == 'phonophobiaexpunged' then
        strums = 'opponent'
        characterBool = false
    elseif getProperty('boyfriend.curCharacter') == 'phonophobiaexpunged' then
        strums = 'player'
        characterBool = true
    end
    if getProperty('boyfriend.curCharacter') == 'phonophobiaexpunged' and getProperty('dad.curCharacter') == 'phonophobiaexpunged' then
        both = true
    end
