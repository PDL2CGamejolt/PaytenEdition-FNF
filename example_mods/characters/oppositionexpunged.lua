...
function onCreatePost()
    ...
    if getProperty('dad.curCharacter') == 'oppositionexpunged' then
        strums = 'opponent'
        characterBool = false
    elseif getProperty('boyfriend.curCharacter') == 'oppositionexpunged' then
        strums = 'player'
        characterBool = true
    end
    if getProperty('boyfriend.curCharacter') == 'oppositionexpunged' and getProperty('dad.curCharacter') == 'oppositionexpunged' then
        both = true
    end
