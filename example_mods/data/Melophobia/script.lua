...
function onUpdate(elasped)
	...
	if modchartStart == true then
		...
		noteTweenX('defaultPlayerStrumX1', 5, defaultPlayerStrumX1 + modchartX * math.cos((currentBeat+2)+300), 0.002)
		noteTweenX('defaultPlayerStrumX2', 6, defaultPlayerStrumX2 + modchartX * math.sin((currentBeat+3)+300), 0.003)
		noteTweenX('defaultPlayerStrumX3', 7, defaultPlayerStrumX3 + modchartX * math.cos((currentBeat+4)+300), 0.004)
		...
		noteTweenX('defaultOpponentStrumX1', 1, defaultOpponentStrumX1 - modchartX * math.cos((currentBeat+2)+300), 0.002)
		noteTweenX('defaultOpponentStrumX2', 2, defaultOpponentStrumX2 - modchartX * math.sin((currentBeat+3)+300), 0.003)
		noteTweenX('defaultOpponentStrumX3', 3, defaultOpponentStrumX3 - modchartX * math.cos((currentBeat+4)+300), 0.004)
...
function onCreatePost()
   makeLuaText("message", "YOU DESERVE TO DIE! [Song by Pyramix, Originally from Strident Crisis]", 500, 30, 30)
