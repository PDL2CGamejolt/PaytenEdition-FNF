...
function onEvent(name, value1, value2)
    if name == 'TextEvent' then
        --Set text stuff
        makeLuaText('text1', value1, 600, 300, 300);--First value - tag. Second - text to write. Third - text width. Fourth - X value. Last - Y value
        setTextString('text1', value1);--Sets text to be written
        setTextSize('text1', 35);--Sets text size
        setTextWidth('text1', 600);--Sets text width
        setTextBorder('text1', 2, '0xFF000000');--Sets text border weight and color
        ...
        setTextAlignment('text1', 'center');--Sets how text is aligned - left, center, right
        --GetProperty Stuff
